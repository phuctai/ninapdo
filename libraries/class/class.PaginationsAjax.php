		...
		function getAllPageLinks($count, $href, $elShow)
		{
			...
			if($pages>1)
			{
				if($_GET["p"] == 1) 
					...
					$output = $output . '<a class="first" onclick="loadPagingAjax(\'' . $href . (1) . '\',\''.$elShow.'\')" >First</a><a onclick="loadPagingAjax(\'' . $href . ($_GET["p"]-1) . '\',\''.$elShow.'\')" >Prev</a>';
				...
				if($_GET["p"] < $pages)
					$output = $output . '<a onclick="loadPagingAjax(\'' . $href . ($_GET["p"]+1) . '\',\''.$elShow.'\')" >Next</a><a onclick="loadPagingAjax(\'' . $href . ($pages) . '\',\''.$elShow.'\')" >Last</a>';
				else				
		...
		function getPrevNext($count, $href, $elShow)
		{
			...
			if($pages>1)
			{
				if($_GET["p"] == 1) 
					...
					$output = $output . '<a class="first" onclick="loadPagingAjax(\'' . $href . ($_GET["p"]-1) . '\',\''.$elShow.'\')" >Prev</a>';			
			
				if($_GET["p"] < $pages)
					$output = $output . '<a onclick="loadPagingAjax(\'' . $href . ($_GET["p"]+1) . '\',\''.$elShow.'\')" >Next</a>';
				else				
