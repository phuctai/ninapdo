<?php
    class Statistic
    {
        ...
        public function getCounter()
        {
            ...
            $t = $this->d->rawQueryOne("select max(id) as total from #_counter");
            ...
            $vip = $this->d->rawQueryOne("select count(*) as visitip from #_counter where ip='$ip' and (tm+'$locktime')>'$now'");
            $items = $vip['visitip'];
            ...
            $todayrec = $this->d->rawQueryOne("select count(*) as todayrecord from #_counter where tm>'$daystart'");
            $yesrec = $this->d->rawQueryOne("select count(*) as yesterdayrec from #_counter where tm>'$yesterdaystart' and tm<'$daystart'");
            $weekrec = $this->d->rawQueryOne("select count(*) as weekrec from #_counter where tm>='$weekstart'");
            $monthrec = $this->d->rawQueryOne("select count(*) as monthrec from #_counter where tm>='$monthstart'");
