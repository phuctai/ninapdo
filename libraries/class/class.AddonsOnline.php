<?php
	class AddonsOnline
	{
		...
		public function setScript($element='', $type='', $scrolltop=1)
		{
			...
			if($element && $type)
			{
				$script = '<script type="text/javascript">$(function(){var a=!1;$(window).scroll(function(){$(window).scrollTop()>'.$scrolltop.' && !a&&($("#'.$element.'").load("ajax/ajax_load_addons.php?type='.$type.'"),a=!0)})});</script>';
