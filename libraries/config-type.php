<?php
    ...
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['position'] = true;
    $config['photo']['photo_static'][$nametype]['removeCacheThumb'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 35;
    $config['photo']['photo_static'][$nametype]['height'] = 35;
    $config['photo']['photo_static'][$nametype]['thumb'] = '35x35x1';
    $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
    ...
    /* Sitemap */
    $config['sitemap']['product'] = array("san-pham","thu-vien-anh");
    $config['sitemap']['news'] = array("tin-tuc","tuyen-dung","chinh-sach");
    $config['sitemap']['static'] = array("gioi-thieu");
    $config['sitemap']['tags'] = array("san-pham","tin-tuc");
