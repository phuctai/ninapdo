 ...
 * @package PRO CODE NINA FRAMEWORK
 * @author  James Nguyễn <thanhthangnina@gmail.com>
 * @version 1.0.0
 * @license https://nina.vn
 * @PHP >=5.6
 */
...
class PDODb
{
    ...
    public function createlogs($user='Unnamed',$act,$com,$id)
    {
        ...
        $data_old = file_get_contents($file);
        ...
        unlink($logsfile."/".$name_file_old.".txt");
    }
