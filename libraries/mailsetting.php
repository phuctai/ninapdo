<?php
    ...
    $logo = '<img src="'.$trangchu.UPLOAD_PHOTO_L.$maillogo['photo'].'" style="max-height:70px;" >';
    ...
    {
        $mangxahoi .= '<a href="'.$mailmxh[$i]['link'].'" target="_blank"><img src="'.$trangchu.UPLOAD_PHOTO_L.$mailmxh[$i]['photo'].'" style="max-height:30px;margin:0 0 0 5px" /></a>';
    }
    $ngaygui = time();
