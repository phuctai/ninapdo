<script type="text/javascript">
	...
	/* Get position watermark */
	function getPosWatermark(e)
    {
        $("#posleft").val(e.x), $("#postop").val(e.y)
    }
	...
	$(document).ready(function(){
        ...
        /* Watermark */
        $("#watermarker-icon").watermarker({
            onChange: getPosWatermark,
            onInitialize: getPosWatermark
        });
        $(document).on("mousemove", function(e) {
            $("#mousex").val(e.pageX), $("#mousey").val(e.pageY)
        });
