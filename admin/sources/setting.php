...
function save_setting()
{
	...
	if(empty($_POST)) $func->transfer("Không nhận được dữ liệu", "index.php?com=setting&act=capnhat",0);
	...
	if($row['id'])
	{
		...
		else $func->transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=setting&act=capnhat",0);
	}
	else
	{
