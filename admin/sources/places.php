...
if(!$config['places']['active']) $func->transfer("Trang không tồn tại", "index.php",0);
...
function get_city()
{
	...
	if(!$id) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);

	$item = $d->rawQueryOne("select * from #_city where id = ?",array($id));

	if(!$item['id']) $func->transfer("Dữ liệu không có thực", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
}
...
function save_city()
{
	...
	if(empty($_POST)) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		else $func->transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
	}
	else
	{
		$data['ngaytao'] = time();
		...
		else $func->transfer("Lưu dữ liệu bị lỗi", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
	}
}
...
function delete_city()
{
	...
	if($id)
	{
		...
		else $func->transfer("Xóa dữ liệu bị lỗi", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
	}
	...
	$func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_city&p=".$curPage.$strUrl,0);
}
...
function get_district()
{
	...
	if(!$id) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
	
	$item = $d->rawQueryOne("select * from #_district where id = ?",array($id));

	if(!$item['id']) $func->transfer("Dữ liệu không có thực", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
}
...
function save_district()
{
	...
	if(empty($_POST)) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		else $func->transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
	}
	else
	{
		$data['ngaytao'] = time();
		...
		else $func->transfer("Lưu dữ liệu bị lỗi", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
	}
}
...
function delete_district()
{
	...
	if($id)
	{
		...
		else $func->transfer("Xóa dữ liệu bị lỗi", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	$func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_district&p=".$curPage.$strUrl,0);
}
...
function get_wards()
{
	...
	if(!$id) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
	
	$item = $d->rawQueryOne("select * from #_wards where id = ?",array($id));

	if(!$item['id']) $func->transfer("Dữ liệu không có thực", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
}
...
function save_wards()
{
	...
	if(empty($_POST)) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		else $func->transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
	}
	else
	{
		$data['ngaytao'] = time();
		...
		else $func->transfer("Lưu dữ liệu bị lỗi", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
	}
}
...
function delete_wards()
{
	...
	if($id)
	{
		...
		else $func->transfer("Xóa dữ liệu bị lỗi", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_wards&p=".$curPage.$strUrl,0);
}
...
function get_street()
{
	...
	if(!$id) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
	
	$item = $d->rawQueryOne("select * from #_street where id = ?",array($id));

	if(!$item['id']) $func->transfer("Dữ liệu không có thực", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
}
...
function save_street()
{
	...
	if(empty($_POST)) $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		else $func->transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
	}
	else
	{
		$data['ngaytao'] = time();
		...
		else $func->transfer("Lưu dữ liệu bị lỗi", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
	}
}
...
function delete_street()
{
	...
	if($id)
	{
		...
		else $func->transfer("Xóa dữ liệu bị lỗi", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else $func->transfer("Không nhận được dữ liệu", "index.php?com=places&act=man_street&p=".$curPage.$strUrl,0);
}
?>