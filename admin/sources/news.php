...
function get_item()
{
	...
	if(!$id) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);

	$item = $d->rawQueryOne("select * from #_news where id = ? and type = ?",array($id,$type));

	if(!$item['id']) transfer("Dữ liệu không có thực", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
...
function save_item()
{
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
	...
	if($id && $act!='save_copy')
	{
		...
		if($d->update('news',$data))
		{
			...
			if($savehere) transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id);
			else transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl);
		}
		else
		{
			if($savehere) transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id,0);
			else transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
		}
	}
	else
	{
		...
		if($d->insert('news',$data))
		{
			...
			if($act=='save_copy')
			{
				if($savehere) transfer("Sao chép dữ liệu thành công", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id_insert);
				else transfer("Sao chép dữ liệu thành công", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl);
			}
			else
			{
				if($savehere) transfer("Lưu dữ liệu thành công", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id_insert);
				else transfer("Lưu dữ liệu thành công", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl);
			}
		}
		else
		{
			if($act=='save_copy')
			{
				if($savehere) transfer("Sao chép dữ liệu bị lỗi", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id_insert,0);
				else transfer("Sao chép dữ liệu bị lỗi", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
			}
			else
			{
				if($savehere) transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=edit&type=".$type."&p=".$curPage.$strUrl."&id=".$id_insert,0);
				else transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
			}
		}
	}
}
...
function delete_item()
{
	...
	if($id)
	{
		...
		if($row['id'])
		{
			...
			transfer("Xóa dữ liệu thành công", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Xóa dữ liệu bị lỗi", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
	}
	...
	else transfer("Không nhận được dữ liệu", "index.php?com=news&act=man&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function get_list()
{
	...
	if(!$id) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);

	$item = $d->rawQueryOne("select * from #_news_list where id = ? and type = ?",array($id,$type));
	
	if(!$item['id']) transfer("Dữ liệu không có thực", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
...
function save_list()
{
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
	...
	{					
		...
		if($d->update('news_list',$data))
		{
			...
			transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
	}
	else
	{				
		if($photo = uploadImage("file", $config['news'][$type]['img_type_list'], UPLOAD_NEWS,$file_name)){
		...
		if($d->insert('news_list',$data))
		{
			...
			transfer("Lưu dữ liệu thành công", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
	}
}
...
function delete_list()
{
	...
	if(isset($_GET['id']))
	{
		...
		if($row['id'])
		{
			...
			transfer("Xóa dữ liệu thành công", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Xóa dữ liệu bị lỗi", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_list&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function get_cat()
{
	...
	if(!$id) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
	
	$item = $d->rawQueryOne("select * from #_news_cat where id = ? and type = ?",array($id,$type));

	if(!$item['id']) transfer("Dữ liệu không có thực", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function save_cat()
{
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		if($d->update('news_cat',$data))
		{
			...
			transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
	}
	else
	{		
		if($photo = uploadImage("file", $config['news'][$type]['img_type_cat'], UPLOAD_NEWS,$file_name))
		...
		if($d->insert('news_cat',$data))
		{
			...
			transfer("Lưu dữ liệu thành công", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
	}
}
...
function delete_cat()
{
	...
	if($id)
	{
		...
		else transfer("Xóa dữ liệu bị lỗi", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_cat&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function get_loai()
{
	...
	if(!$id) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
	
	$item = $d->rawQueryOne("select * from #_news_item where id = ? and type = ?",array($id,$type));

	if(!$item['id']) transfer("Dữ liệu không có thực", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function save_loai()
{
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		if($d->update('news_item',$data))
		{
			...
			transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
	}
	else
	{	
		if($photo = uploadImage("file", $config['news'][$type]['img_type_item'], UPLOAD_NEWS,$file_name))
		...
		if($d->insert('news_item',$data))
		{
			...
			transfer("Lưu dữ liệu thành công", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
	}
}
...
function delete_loai()
{
	...
	if($id)
	{
		...
		else transfer("Xóa dữ liệu bị lỗi", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_item&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function get_sub()
{
	...
	if(!$id) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);

	$item = $d->rawQueryOne("select * from #_news_sub where id = ? and type = ?",array($id,$type));

	if(!$item['id']) transfer("Dữ liệu không có thực", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
}
...
function save_sub()
{
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
	...
	if($id)
	{
		...
		if($d->update('news_sub',$data))
		{
			...
			transfer("Cập nhật dữ liệu thành công", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
	}
	else
	{	
		if($photo = uploadImage("file", $config['news'][$type]['img_type_sub'], UPLOAD_NEWS,$file_name))
		...
		if($d->insert('news_sub',$data))
		{
			...
			transfer("Lưu dữ liệu thành công", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl);
		}
		else transfer("Lưu dữ liệu bị lỗi", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
	}
}
...
function delete_sub()
{
	...
	if($id)
	{
		...
		else transfer("Xóa dữ liệu bị lỗi", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
	}
	elseif(isset($_GET['listid']))
	{
		$listid = explode(",",$_GET['listid']);
	...
	else transfer("Không nhận được dữ liệu", "index.php?com=news&act=man_sub&type=".$type."&p=".$curPage.$strUrl,0);
}
?>