        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php if($config['photo']['photo_static'][$type]['images']) { ?>
                    <div class="form-group">
                        <label class="change-photo" for="file">
                            <p>Upload hình ảnh:</p>
                            <div class="rounded">
                                <img class="rounded img-upload" id="watermark" left="<?=$item['posleft']?>" top="<?=$item['postop']?>" src="<?=THUMBS?>/<?=$config['photo']['photo_static'][$type]['thumb']?>/<?=UPLOAD_PHOTO_L.$item['photo']?>" onerror="src='assets/images/noimage.png'" alt="Alt Photo"/>
                                <strong>
                ...
                <?php if($config['photo']['photo_static'][$type]['position'] && file_exists(UPLOAD_PHOTO.$item['photo']) && $item['photo']) { ?>
                    <div class="form-group">
                        <link rel="styleSheet" href="assets/watermark/watermark.css" type="text/css">
                        <label>Vị trí đóng dấu:</label>
                        <div class="watermarker"><div class="watermarker-area"><img src="" id="watermarker-icon"></div></div>
                        <input type="hidden" name="data[posleft]" id="posleft" value="<?=$item['posleft']?>"/>
                        <input type="hidden" name="data[postop]" id="postop" value="<?=$item['postop']?>"/>
                        <script src="assets/watermark/watermark.js"></script>
                    </div>
                <?php } ?>
                <div class="row">
