    ...
    <form method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                <?php if($config['photo']['photo_static'][$type]['position']) { ?>
                    <?php
                        $tl = ($item['position'] == 1 || !$item['position']) ? 'checked' : '';
                        $tc = ($item['position'] == 2) ? 'checked' : '';
                        $tr = ($item['position'] == 3) ? 'checked' : '';
                        $mr = ($item['position'] == 4) ? 'checked' : '';
                        $br = ($item['position'] == 5) ? 'checked' : '';
                        $bc = ($item['position'] == 6) ? 'checked' : '';
                        $bl = ($item['position'] == 7) ? 'checked' : '';
                        $ml = ($item['position'] == 8) ? 'checked' : '';
                        $cc = ($item['position'] == 9) ? 'checked' : '';
                    ...
                    <div class="form-group">
                        ...
                        <div class="watermark-position rounded">
                            <label for="tl">
                                <input type="radio" name="data[position]" id="tl" value="1" <?=$tl?>>
                                <img class="rounded" src="<?=($tl) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="tc">
                                <input type="radio" name="data[position]" id="tc" value="2" <?=$tc?>>
                                <img class="rounded" src="<?=($tc) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="tr">
                                <input type="radio" name="data[position]" id="tr" value="3" <?=$tr?>>
                                <img class="rounded" src="<?=($tr) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="mr">
                                <input type="radio" name="data[position]" id="mr" value="4" <?=$mr?>>
                                <img class="rounded" src="<?=($mr) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="br">
                                <input type="radio" name="data[position]" id="br" value="5" <?=$br?>>
                                <img class="rounded" src="<?=($br) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="bc">
                                <input type="radio" name="data[position]" id="bc" value="6" <?=$bc?>>
                                <img class="rounded" src="<?=($bc) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="bl">
                                <input type="radio" name="data[position]" id="bl" value="7" <?=$bl?>>
                                <img class="rounded" src="<?=($bl) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="ml">
                                <input type="radio" name="data[position]" id="ml" value="8" <?=$ml?>>
                                <img class="rounded" src="<?=($ml) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                            <label for="cc">
                                <input type="radio" name="data[position]" id="cc" value="9" <?=$cc?>>
                                <img class="rounded" src="<?=($cc) ? $watermark : ''?>" alt="watermark-cover">
                            </label>
                        </div>
                    </div>
                <?php } ?>
