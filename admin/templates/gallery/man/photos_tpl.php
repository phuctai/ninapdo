            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if($config[$com][$type][$dfgallery][$val]['avatar_photo']) { ?>
                            ...
                            <tr>
                                ...
                                <?php if($config[$com][$type][$dfgallery][$val]['avatar_photo']) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?="../upload/".$com."/".$items[$i]['photo']?>" alt="<?=$items[$i]['tenvi']?>"></a>
	                                </td>
	                            <?php } ?>
                                <?php if($config[$com][$type][$dfgallery][$val]['tieude_photo']) { ?>
	                                <td class="align-middle">
                                ...
                                <?php if($config[$com][$type][$dfgallery][$val]['cart_photo']) { ?>
						        	<td class="align-middle">
						        		<?php $mauDetail=$func->get_mau_cart($items[$i]['id_mau']); ?>
