            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if(count($config['product'])>0) { ?>
                    <?php foreach($config['product'] as $k => $v) { ?>
                        <?php
                            ...
                            $active = "";
                            $menuopen = "";
                            if($kiemtra) if($func->check_access('product','man_list',$k) && $func->check_access('product','man_cat',$k) && $func->check_access('product','man_item',$k) && $func->check_access('product','man_sub',$k) && $func->check_access('product','man_brand',$k) && $func->check_access('product','man',$k) && $func->check_access('import','man',$k) && $func->check_access('export','man',$k)) $none = "d-none";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if($v['list']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_list',$k)) $none = "d-none";
                                ...
                                <?php if($v['cat']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_cat',$k)) $none = "d-none";
                                ...
                                <?php if($v['item']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_item',$k)) $none = "d-none";
                                ...
                                <?php if($v['sub']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_sub',$k)) $none = "d-none";
                                ...
                                <?php if($v['brand']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_brand',$k)) $none = "d-none";
                                ...
                                <?php if($v['mau']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_mau',$k)) $none = "d-none";
                                ...
                                <?php if($v['size']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man_size',$k)) $none = "d-none";
                                ...
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('product','man',$k)) $none = "d-none";
                                ...
                                <?php if($v['import']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('import','man',$k)) $none = "d-none";
                                ...
                                <?php if($v['export']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('export','man',$k)) $none = "d-none";
                ...
                <?php if(count($config['news'])) { ?>
                    <?php foreach($config['news'] as $k => $v) { if($v['dropdown']) { ?>
                        <?php
                            ...
                            $active = "";
                            $menuopen = "";
                            if($kiemtra) if($func->check_access('news','man_list',$k) && $func->check_access('news','man_cat',$k) && $func->check_access('news','man_item',$k) && $func->check_access('news','man_sub',$k) && $func->check_access('news','man',$k)) $none = "d-none";
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if($v['list']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('news','man_list',$k)) $none = "d-none";
                                ...
                                <?php if($v['cat']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('news','man_cat',$k)) $none = "d-none";
                                ...
                                <?php if($v['item']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('news','man_item',$k)) $none = "d-none";
                                ...
                                <?php if($v['sub']) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('news','man_sub',$k)) $none = "d-none";
                                ...
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('news','man',$k)) $none = "d-none";
                ...
                <?php if($config['shownews']) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access2('news','man',$config['news'])) $none = "d-none";
                ...
                <?php if($config['order']['active']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if($func->check_access('order','man','')) $none = "d-none";
                ...
                <?php if($config['coupon']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if($func->check_access('coupon','man','')) $none = "d-none";
                ...
                <?php if(count($config['tags'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access2('tags','man',$config['tags'])) $none = "d-none";
                        if($com=='tags')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['tags'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('tags','man',$k)) $none = "d-none";
                ...
                <?php if(count($config['newsletter'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access2('newsletter','man',$config['newsletter'])) $none = "d-none";
                        if($com=='newsletter')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['newsletter'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('newsletter','man',$k)) $none = "d-none";
                ...
                <?php if(count($config['static'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access2('static','capnhat',$config['static'])) $none = "d-none";
                        if($com=='static')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['static'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('static','capnhat',$k)) $none = "d-none";
                ...
                <?php if(count($config['photo'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access2('photo','photo_static',$config['photo']['photo_static']) && $func->check_access2('photo','man_photo',$config['photo']['man_photo'])) $none = "d-none";
                        if($com=='photo')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(count($config['photo']['photo_static'])) { ?>
                                <?php foreach($config['photo']['photo_static'] as $k => $v) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('photo','photo_static',$k)) $none = "d-none";
                            ...
                            <?php if(count($config['photo']['man_photo'])) { ?>
                                <?php foreach($config['photo']['man_photo'] as $k => $v) {
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('photo','man_photo',$k)) $none = "d-none";
                ...
                <?php if($config['places']['active']) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access('places','man_city','') && $func->check_access('places','man_district','') && $func->check_access('places','man_wards','') && $func->check_access('places','man_street','')) $none = "d-none";
                        if($com=='places')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if($func->check_access('places','man_city','')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if($func->check_access('places','man_district','')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if($func->check_access('places','man_wards','')) $none = "d-none";
                            ...
                            <?php
                                $none = "";
                                $active = "";
                                if($kiemtra) if($func->check_access('places','man_street','')) $none = "d-none";
                ...
                <!-- User -->
                <?php if($config['user']['active'] && !$func->check_access3()) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        $menuopen = "";
                ...
                <?php if($config['onesignal']) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if($kiemtra) if($func->check_access('pushOnesignal','man','')) $none = "d-none";
                ...
                <?php if(count($config['seopage'])) { ?>
                    <?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if($kiemtra) if($func->check_access21('seopage','capnhat',$config['seopage']['page'])) $none = "d-none";
                        if($com=='seopage')
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['seopage']['page'] as $k => $v) { ?>
                                <?php
                                    $none = "";
                                    $active = "";
                                    if($kiemtra) if($func->check_access('seopage','capnhat',$k)) $none = "d-none";
                ...
                <?php
                    $none = "";
                    $active = "";
                    if($kiemtra) if($func->check_access('setting','capnhat','')) $none = "d-none";
