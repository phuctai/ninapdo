<?php
    ...
    function getCity()
    {
        ...
        $str = '<select id="city" name="id_city" data-level="0" data-table="table_district" data-child="district" class="form-control select2 select-place"><option value="0">Chọn danh mục</option>';
        foreach($row as $v)
        {
    ...
    function getDistrict()
    {
        ...
        $str = '<select id="district" name="id_district" data-level="1" data-type="'.$type.'" data-table="table_wards" data-child="wards" class="form-control select2 select-place"><option value="0">Chọn danh mục</option>';
        foreach($row as $v)
        {
