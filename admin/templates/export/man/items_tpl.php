<?php
    function get_main_list()
    {
        ...
        $str = '<select id="id_list" name="id_list" data-level="0" data-type="'.$type.'" data-table="table_product_cat" data-child="id_cat" class="form-control select2 select-category"><option value="0">Chọn danh mục</option>';
        foreach($row as $v)
        {
    ...
    function get_main_cat()
    {
        ...
        $str='<select id="id_cat" name="id_cat" data-level="1" data-type="'.$type.'" data-table="table_product_item" data-child="id_item" class="form-control select2 select-category"><option value="0">Chọn danh mục</option></select>';
        return $str;
    }
    ...
    function get_main_item()
    {
        ...
        $str='<select id="id_item" name="id_item" data-level="2" data-type="'.$type.'" data-table="table_product_sub" data-child="id_sub" class="form-control select2 select-category"><option value="0">Chọn danh mục</option></select>';
        return $str;
    }
