<?php
	function get_main_city()
    {
        ...
        $str = '<select id="id_city" name="id_city" onchange="onchangeList()" class="form-control select2"><option value="">Tỉnh thành</option>';
        foreach($row as $v)
        {
    ...
    function get_main_district()
    {
        ...
        $str = '<select id="id_district" name="id_district" onchange="onchangeCat()" class="form-control select2"><option value="">Quận huyện</option>';
        foreach($row as $v)
        {
	...
	function get_main_wards()
	{
		...
		$str = '<select id="id_wards" name="id_wards" onchange="onchangeItem()" class="form-control select2"><option value="">Phường xã</option>';
		foreach($row as $v)
        {
