<?php
	function get_main_city()
	{
		...
		$str = '<select id="city" name="data[id_city]" data-level="0" data-table="table_district" data-child="district" class="form-control select2 select-place"><option value="">Chọn danh mục</option>';
		foreach($row as $v)
        {
	...
	function get_main_district()
	{
		...
		$str = '<select id="district" name="data[id_district]" data-level="1" data-table="table_wards" data-child="wards" class="form-control select2 select-place"><option value="">Chọn danh mục</option>';
		foreach($row as $v)
        {
	...
	function get_main_wards()
	{
		...
		$str = '<select id="wards" name="data[id_wards]" class="form-control select2"><option value="">Chọn danh mục</option>';
		foreach($row as $v)
        {
