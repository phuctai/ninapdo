            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if($config['newsletter'][$type]['showten']) { ?>
                            <th class="align-middle">Họ tên</th>
                        <?php } ?>
                        <?php if($config['newsletter'][$type]['email']) { ?>
                            <th class="align-middle">Email</th>
                        <?php } ?>
                        <?php if($config['newsletter'][$type]['showdienthoai']) { ?>
                            <th class="align-middle">Điện thoại</th>
                        <?php } ?>
                        <?php if($config['newsletter'][$type]['file']) { ?>
                            <th class="align-middle">Download</th>
                        <?php } ?>
                        <?php if($config['newsletter'][$type]['showngaytao']) { ?>
                            <th class="align-middle">Ngày tạo</th>
                        <?php } ?>
                        <?php if(count($config['newsletter'][$type]['tinhtrang'])>0) { ?>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <?php } ?>
                                <?php if(count($config['newsletter'][$type]['tinhtrang'])) { ?>
                                    <td class="align-middle"><?=$func->get_status_email($items[$i]['tinhtrang'],$type)?></td>
                                <?php } ?>
