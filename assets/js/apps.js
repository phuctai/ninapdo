...
NN_FRAMEWORK.Tools = function(){
    if($(".toolbar").exists()) $(".footer").css({marginBottom:$(".toolbar").innerHeight()});
};

/* Popup */
NN_FRAMEWORK.Popup = function(){
    if($("#popup").exists()) $('#popup').modal('show');
};
...
NN_FRAMEWORK.Mmenu = function(){
    if($("nav#menu").exists()) $('nav#menu').mmenu();
};
...
NN_FRAMEWORK.Photobox = function(){
    if($(".album-gallery").exists()) $('.album-gallery').photobox('a',{thumbs:true,loop:false});
};
