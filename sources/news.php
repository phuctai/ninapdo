<?php  
	...
	if($id!='')
	{
		...
		/* SEO */
		$seo = get_seo($row_detail['id'],'news','man',$row_detail['type']);
	...
	else if($idl!='')
	{
		...
		$seo = get_seo($news_list['id'],'news','man_list',$news_list['type']);
		if($config['website']['seo']['headings'])
		{
			$seo_h1 = $seo['seo_h1'.$seolangkey];
			$seo_h2 = $seo['seo_h2'.$seolangkey];
	...
	else if($idc!='')
	{
		...
		$seo = get_seo($news_cat['id'],'news','man_cat',$news_cat['type']);
		if($config['website']['seo']['headings'])
		{
			$seo_h1 = $seo['seo_h1'.$seolangkey];
			$seo_h2 = $seo['seo_h2'.$seolangkey];
	...
	else if($idi!='')
	{
		...
		$seo = get_seo($news_item['id'],'news','man_item',$news_item['type']);
		if($config['website']['seo']['headings'])
		{
			$seo_h1 = $seo['seo_h1'.$seolangkey];
			$seo_h2 = $seo['seo_h2'.$seolangkey];
	...
	else if($ids!='')
	{
		...
		$seo = get_seo($news_sub['id'],'news','man_sub',$news_sub['type']);
		if($config['website']['seo']['headings'])
		{
			$seo_h1 = $seo['seo_h1'.$seolangkey];
			$seo_h2 = $seo['seo_h2'.$seolangkey];
