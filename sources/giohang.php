<?php
	...
	/* breadCrumbs */
	if($title_crumb) $data['breadcrumbs'][] = array('slug'=>$func->get_comlang('gio-hang',$lang),'name'=>$title_crumb);
	...
	if(isset($_POST['thanhtoan']))
	{
		...
		require_once LIBRARIES."mailsetting.php";
		...
		$message = $noidung;
		$func->sendEmail("admin", $arrayEmail, $subject, $message, $file);
		...
		$subject = "Thông tin đơn hàng từ ".$setting['ten'.$lang];
		$message = $noidungkh;
		$func->sendEmail("customer", $arrayEmail, $subject, $message, $file);
