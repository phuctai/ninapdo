<?php  
	...
	if($id!='')
	{
		...
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$pro_list['id'],'product_list'),'name'=>$pro_list['ten'.$lang]);
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$pro_cat['id'],'product_cat'),'name'=>$pro_cat['ten'.$lang]);
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$pro_item['id'],'product_item'),'name'=>$pro_item['ten'.$lang]);
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$pro_sub['id'],'product_sub'),'name'=>$pro_sub['ten'.$lang]);
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$row_detail['id'],'product'),'name'=>$row_detail['ten'.$lang]);
	...
	else if($idb!='')
	{
		...
		/* breadCrumbs */
		$data['breadcrumbs'][] = array('slug'=>$func->get_slug($lang,$pro_brand['id'],'product_brand'),'name'=>$title_cat);
		$breadcrumbs = $breadcr->getUrl(trangchu, $data['breadcrumbs']);
	}
	else
	{
