...
<?php if($type == 'video-fotorama') {
	...
	<!-- Video Fotorama -->
	<div class="fotorama" data-width="100%" data-thumbmargin="5" data-height="360" data-fit="cover" data-thumbwidth="100" data-thumbheight="85" data-allowfullscreen="false" data-nav="thumbs">
