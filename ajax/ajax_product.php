<?php 
	...
	/* Get data */
	$sql = "select ten$lang, tenkhongdauvi, tenkhongdauen, id, photo, gia, giamoi, giakm, type from #_product where type='san-pham' and noibat > 0 and hienthi > 0 order by stt,id desc";
