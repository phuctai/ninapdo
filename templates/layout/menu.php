                    ...
                    <?php if(count($splistmenu)) { ?>
                        <ul>
                            <?php for($i=0;$i<count($splistmenu); $i++) {
                                ...
                                <li>
                                    <a class="transition" title="<?=$splistmenu[$i]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$splistmenu[$i]['id'],'product_list')?>"><h2><?=$splistmenu[$i]['ten'.$lang]?></h2></a>
                                    <?php if(count($spcatmenu)>0) { ?>
                                        <ul>
                                            <?php for($j=0;$j<count($spcatmenu);$j++) {
                                                ...
                                                <li>
                                                    <a class="transition" title="<?=$spcatmenu[$j]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$spcatmenu[$j]['id'],'product_cat')?>"><h2><?=$spcatmenu[$j]['ten'.$lang]?></h2></a>
                                                    <?php if(count($spitemmenu)) { ?>
                                                        <ul>
                                                            <?php for($u=0;$u<count($spitemmenu);$u++) {
                                                                ...
                                                                <li>
                                                                    <a class="transition" title="<?=$spitemmenu[$u]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$spitemmenu[$u]['id'],'product_item')?>"><h2><?=$spitemmenu[$u]['ten'.$lang]?></h2></a>
                                                                    <?php if(count($spsubmenu)) { ?>
                                                                        <ul>
                                                                            <?php for($s=0;$s<count($spsubmenu);$s++) { ?>
                                                                                <li>
                                                                                    <a class="transition" title="<?=$spsubmenu[$s]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$spsubmenu[$s]['id'],'product_sub')?>"><h2><?=$spsubmenu[$s]['ten'.$lang]?></h2></a>
                                                                                </li>
                                                                            <?php } ?>
                                                                        </ul>
                                                                    <?php } ?>
                    ...
                    <?php if(count($ttlistmenu)) { ?>
                        <ul>
                            <?php for($i=0;$i<count($ttlistmenu); $i++) {
                                ...
                                <li>
                                    <a class="transition" title="<?=$ttlistmenu[$i]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$ttlistmenu[$i]['id'],'news_list')?>"><h2><?=$ttlistmenu[$i]['ten'.$lang]?></h2></a>
                                    <?php if(count($ttcatmenu)>0) { ?>
                                        <ul>
                                            <?php for($j=0;$j<count($ttcatmenu);$j++) {
                                                ...
                                                <li>
                                                    <a class="transition" title="<?=$ttcatmenu[$j]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$ttcatmenu[$j]['id'],'news_cat')?>"><h2><?=$ttcatmenu[$j]['ten'.$lang]?></h2></a>
                                                    <?php if(count($ttitemmenu)) { ?>
                                                        <ul>
                                                            <?php for($u=0;$u<count($ttitemmenu);$u++) {
                                                                ...
                                                                <li>
                                                                    <a class="transition" title="<?=$ttitemmenu[$u]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$ttitemmenu[$u]['id'],'news_item')?>"><h2><?=$ttitemmenu[$u]['ten'.$lang]?></h2></a>
                                                                    <?php if(count($ttsubmenu)) { ?>
                                                                        <ul>
                                                                            <?php for($s=0;$s<count($ttsubmenu);$s++) { ?>
                                                                                <li>
                                                                                    <a class="transition" title="<?=$ttsubmenu[$s]['ten'.$lang]?>" href="<?=$func->get_slug($lang,$ttsubmenu[$s]['id'],'news_sub')?>"><h2><?=$ttsubmenu[$s]['ten'.$lang]?></h2></a>
                                                                                </li>
                                                                            <?php } ?>
                                                                        </ul>
                                                                    <?php } ?>
