    ...
    <div class="wrap-content d-flex align-items-center justify-content-between">
        <div class="ddsmoothmenu" id="smoothmenu1">
            <ul class="d-flex align-items-center justify-content-start">
                ...
                <li class="line"></li>
                <li class="li-first"><a class="transition <?php if($com=='gioi-thieu') echo 'active'; ?>" href="gioi-thieu" title="<?=gioithieu?>"><h2><?=gioithieu?></h2></a></li>
                <li class="line"></li>
                <li class="li-first">
                ...
                <li class="line"></li>
                <li class="li-first"><a class="transition <?php if($com=='tuyen-dung') echo 'active'; ?>" href="tuyen-dung" title="<?=tuyendung?>"><h2><?=tuyendung?></h2></a></li>
                <li class="line"></li>
                <li class="li-first"><a class="transition <?php if($com=='thu-vien-anh') echo 'active'; ?>" href="tuyen-dung" title="<?=thuvienanh?>"><h2><?=thuvienanh?></h2></a></li>
                <li class="line"></li>
                <li class="li-first"><a class="transition <?php if($com=='video') echo 'active'; ?>" href="video" title="Video"><h2>Video</h2></a></li>
                <li class="line"></li>
                <li class="li-first"><a class="transition <?php if($com=='lien-he') echo 'active'; ?>" href="lien-he" title="<?=lienhe?>"><h2><?=lienhe?></h2></a></li>
            </ul>
        </div>
