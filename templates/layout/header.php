<div class="header">
	...
	<div class="header-bottom">
		<div class="wrap-content d-flex align-items-center justify-content-between">
			<a class="logo-header" href=""><img onerror="this.src='//placehold.it/120x100';" src="<?=THUMBS?>/120x100x2/<?=UPLOAD_PHOTO_L.$logo['photo']?>"/></a>
			<a class="banner-header" href=""><img onerror="this.src='//placehold.it/730x120';" src="<?=THUMBS?>/730x120x2/<?=UPLOAD_PHOTO_L.$banner['photo']?>"/></a>
