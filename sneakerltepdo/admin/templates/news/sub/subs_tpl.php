<?php
	...
	function get_main_item()
	{
        ...
        $str = '<select id="id_item" name="id_item" onchange="onchangeItem()" class="form-control select2"><option value="">Chọn danh mục</option>';
        foreach($row as $v)
        {
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
						...
						<?php if($config['news'][$type]['show_images_sub']) { ?>
							<th class="align-middle">Hình</th>
						<?php } ?>
						<th class="align-middle" style="width:30%">Tiêu đề</th>
						<?php foreach($config['news'][$type]['check_sub'] as $key => $value) { ?>
